...
public class ActualStatusAction extends CommonService {
    ...
    public SearchMap actualStatusInsertList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("str.tam.actualStatus.getInsertList", searchMap));
    ...
    public SearchMap actualStatusApproveList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("str.tam.actualStatus.getApproveList", searchMap));
    ...
    public SearchMap actualStatusModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("str.tam.actualStatus.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("str.tam.actualStatus.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("str.tam.actualStatus.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
			...
			searchMap.put("subjectMetricId", subjectMetricIds[i]);
		            returnMap = updateData("str.tam.actualStatus.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap actualInsertStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("str.tam.actualStatus.getInsertList", searchMap));
    ...
    public SearchMap actualApproveStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelSearchInfoList", excelSearchInfoList);
    	searchMap.put("excelInfoList", excelInfoList);
    	searchMap.put("excelDataList", (ArrayList)getList("str.tam.actualStatus.getApproveList", searchMap));
    ...
    public SearchMap callDB(SearchMap searchMap) {
        ...
        try {
        	...
        	if("SP_STR_SCORE".equals(searchMap.get("procId"))){
        		returnMap = insertData("str.tam.actualStatus.callSpStrScoreProc", searchMap);
        	}else{
        		returnMap = insertData("str.tam.actualStatus.callSpStrActualProc", searchMap);
        	}
