...
public class TechnicalEdcAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap technicalEdcList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
        	
			searchMap.put("findDeptId", getStr("bsc.popup.technicalEdc.getScDeptMapping", searchMap));
		}

        searchMap.addList("deptInfo", getList("bsc.popup.technicalEdc.getDeptInfo", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.technicalEdc.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap technicalEdcList_xml(SearchMap searchMap) {

    	String itemCd = searchMap.getString("findItemCd");

    		searchMap.addList("list", getList("bsc.popup.technicalEdc.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "2014년도 교육원 전문교육(신규) 수입목표 달성(650백만원) 실적";
    	String excelTitle = "2014년도 교육원 전문교육(신규) 수입목표 달성(650백만원) 실적";
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.technicalEdc.getList", searchMap));
    	return searchMap;
    }
