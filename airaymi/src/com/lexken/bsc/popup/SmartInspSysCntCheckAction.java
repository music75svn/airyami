...
public class SmartInspSysCntCheckAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap smartInspSysCntCheckList(SearchMap searchMap) {
    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.smartInspSysCntCheck.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.popup.smartInspSysCntCheck.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.smartInspSysCntCheck.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap smartInspSysCntCheckList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.smartInspSysCntCheck.getCountList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	excelInfoList.add(new ExcelVO("검사일자",	"INSP_DATE", 		"center"));
    	excelInfoList.add(new ExcelVO("건수", 	"CNT_TOTAL", 		"center"));
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.smartInspSysCntCheck.getList", searchMap));
