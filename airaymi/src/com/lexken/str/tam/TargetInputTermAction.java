...
public class TargetInputTermAction extends CommonService {
    ...
    public SearchMap targetInputTermList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("str.tam.targetInputTerm.getList", searchMap));
    ...
    public SearchMap targetInputTermModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("str.tam.targetInputTerm.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	         ...
	         * 해당 년도 등록여부 확인
	         **********************************/
	        int cnt = getInt("str.tam.targetInputTerm.getCount", searchMap);
	        ...
	        if(0 < cnt) {
	        	...
	        	returnMap = insertData("str.tam.targetInputTerm.insertData", searchMap);
	        }  
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("str.tam.targetInputTerm.updateData", searchMap);
	    ...
	    try {
	        ...
	        if(null != years && 0 < years.length) {
	        	 for (int i = 0; i < years.length; i++) {
		            ...
		            returnMap = updateData("str.tam.targetInputTerm.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap targetInputTermListExcel(SearchMap searchMap) {
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("str.tam.targetInputTerm.getList", searchMap));
