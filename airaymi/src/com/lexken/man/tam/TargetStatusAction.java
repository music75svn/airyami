...
public class TargetStatusAction extends CommonService {
    ...
    public SearchMap targetStatusInsertList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("man.tam.targetStatus.getInsertList", searchMap));
    ...
    public SearchMap targetStatusCheckList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("man.tam.targetStatus.getCheckList", searchMap));
    ...
    public SearchMap targetStatusApproveList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("man.tam.targetStatus.getApproveList", searchMap));
    ...
    public SearchMap targetInsertStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("man.tam.targetStatus.getInsertList", searchMap));
    ...
    public SearchMap targetCheckStatusListExcel(SearchMap searchMap) {
         ...
         ****************************************************************************************************/
    	ArrayList<ExcelVO> excelInfoList = new ArrayList<ExcelVO>();
    	excelInfoList.add(new ExcelVO("확인담당자", "APPROVE_USER_NM", "left"));
    	excelInfoList.add(new ExcelVO("확인부서", "APPROVE_DEPT_NM", "left"));
    	excelInfoList.add(new ExcelVO("전체", "TOT_CNT", "left"));
    	excelInfoList.add(new ExcelVO("미입력", "CNT01", "left"));
    	excelInfoList.add(new ExcelVO("입력완료", "CNT02", "left"));
    	excelInfoList.add(new ExcelVO("확인요청", "CNT06", "left"));
    	...
    	searchMap.put("excelSearchInfoList", excelSearchInfoList);
    	searchMap.put("excelInfoList", excelInfoList);
    	searchMap.put("excelDataList", (ArrayList)getList("man.tam.targetStatus.getCheckList", searchMap));
    ...
    public SearchMap targetApproveStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelSearchInfoList", excelSearchInfoList);
    	searchMap.put("excelInfoList", excelInfoList);
    	searchMap.put("excelDataList", (ArrayList)getList("man.tam.targetStatus.getApproveList", searchMap));
    ...
    public SearchMap callDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("man.tam.targetStatus.callSpTargetProc", searchMap);
