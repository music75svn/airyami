...
public class ActInputTermAction extends CommonService {
    ...
    public SearchMap actInputTermList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("str.tam.actInputTerm.getList", searchMap));
    ...
    public SearchMap actInputTermModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("str.tam.actInputTerm.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	         ...
	         * 해당 년도 등록여부 확인
	         **********************************/
	        int cnt = getInt("str.tam.actInputTerm.getCount", searchMap);
	        ...
	        if(0 < cnt) {
	        	...
	        	returnMap = insertData("str.tam.actInputTerm.insertData", searchMap);
	        }  
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("str.tam.actInputTerm.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
	        ...
	        for (int i = 0; i < months.length; i++) {
	            ...
	            returnMap = updateData("str.tam.actInputTerm.deleteData", searchMap);
	        }
    ...
    public SearchMap actInputTermListExcel(SearchMap searchMap) {
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("str.tam.actInputTerm.getList", searchMap));
