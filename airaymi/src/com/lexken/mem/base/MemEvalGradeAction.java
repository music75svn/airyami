...
public class MemEvalGradeAction extends CommonService {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeList(SearchMap searchMap) {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeList_xml(SearchMap searchMap) {
        
        searchMap.addList("list", getList("mem.base.memEvalGrade.getList", searchMap));
     ...
     * @throws 
     */
    public SearchMap memEvalGradeModify(SearchMap searchMap) {
    	String stMode = searchMap.getString("mode");
        
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("mem.base.memEvalGrade.getDetail", searchMap));
    	}
     ...
     * @throws 
     */
    public SearchMap memEvalGradeProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("mem.base.memEvalGrade.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("mem.base.memEvalGrade.updateData", searchMap);
	    ...
	    try {
	        ...
	        if(null != evalMethodIds && 0 < evalMethodIds.length) {
		        for (int i = 0; i < evalMethodIds.length; i++) {
		            ...
		            returnMap = updateData("mem.base.memEvalGrade.deleteData", searchMap);
		        }
		    }
     ...
     * @throws 
     */  
    public SearchMap memEvalGradeListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("mem.base.memEvalGrade.getList", searchMap));
