...
public class WorkProductivityLocalAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap workProductivityLocalList(SearchMap searchMap) {
    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.workProductivityLocal.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.popup.workProductivityLocal.getDeptList", searchMap));
    	
    	searchMap.addList("itemInfo", getList("bsc.popup.workProductivityLocal.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap workProductivityLocalList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.workProductivityLocal.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	excelInfoList.add(new ExcelVO("방법", 	"ROLE_TC_NM", 		"center"));
    	excelInfoList.add(new ExcelVO("종류", 	"INSP_KIND_TC_NM", 	"center"));
    	...
    	ArrayList list = (ArrayList)getList("bsc.popup.workProductivityLocal.getList", searchMap);
