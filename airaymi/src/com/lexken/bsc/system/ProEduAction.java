...
public class ProEduAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap proEduList(SearchMap searchMap) {
    	searchMap.addList("getDeptList", getList("bsc.system.proEdu.getDeptList", searchMap));

    	if("".equals(searchMap.getString("findDeptId"))) {
        	searchMap.put("findDeptId", searchMap.getDefaultValue("getDeptList", "DEPT_ID", 0));
        }
     ...
     * @throws
     */
    public SearchMap proEduList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.system.proEdu.getList", searchMap));
