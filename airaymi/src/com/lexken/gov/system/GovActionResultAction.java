...
public class GovActionResultAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap govActionResultList(SearchMap searchMap) {
     ...
     * @throws
     */
    public SearchMap govActionResultList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("gov.system.govActionResult.getList", searchMap));
     ...
     * @throws
     */
    public SearchMap govActionResultModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
	         ...
	         * 지표그룹 상세조회
	         **********************************/
	    	detail = getDetail("gov.system.govActionResult.getDetail", searchMap);
     ...
     * @throws
     */
    public SearchMap govActionResultProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	         ...
	         * 지표 코드 채번
	         **********************************/
	        String planId = getStr("gov.system.govActionResult.getPlanId", searchMap);
	        searchMap.put("planId", planId);

        	returnMap = insertData("gov.system.govActionResult.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("gov.system.govActionResult.updateData", searchMap);
	    ...
	    try {
	        ...
	        if(null != planIds && 0 < planIds.length) {
		        for (int i = 0; i < planIds.length; i++) {
		            ...
		            returnMap = deleteData("gov.system.govActionResult.deleteData", searchMap);
		        }
		    }
     ...
     * @throws
     */
    public SearchMap govActionResultListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", getList("gov.system.govActionResult.getList", searchMap));
