...
public class PlanConApproveAction extends CommonService {
    ...
    /**
     * 직원개인업무성과 성과계획서 확인리스트 관리 데이터 조회(xml)
     * @param      
     * @return String  
     * @throws 
     */
    public SearchMap evalMngList_xml(SearchMap searchMap) {
    	...
    	searchMap.addList("list", getList("prs.mngCon.planConApprove.getEvalList", searchMap));
    	
    	return searchMap;
    }
    
    /**
     * 직원개인평가 부서장/주관부서확인 조회
     * @param      
     * @return String  
     * @throws 
     */
    public SearchMap planConApproveList(SearchMap searchMap) {
    ...
    /**
     * 직원개인평가 부서장/주관부서확인 데이터 조회(xml)
     * @param      
     * @return String  
     * @throws 
     */
    public SearchMap planConApproveList_xml(SearchMap searchMap) {
    ...
    public SearchMap popReturnReason(SearchMap searchMap) {
    	...
    	searchMap.addList("return", getDetail("prs.mngCon.planConApprove.getReturnList", searchMap));
    	return searchMap;
    }
     ...
     * @throws 
     */
    public SearchMap planConMngProcess(SearchMap searchMap) {
    	...
    	if("LISTAPPROVE".equals(stMode)) { 
    		...
    		searchMap = listReturnDB(searchMap);
    	}
    ...
    /**
     * 직원개인평가 부서장/주관부서확인 등록/수정/삭제
     * @param      
     * @return String  
     * @throws 
     */
    public SearchMap planConApproveProcess(SearchMap searchMap) {
        HashMap returnMap = new HashMap();
        String stMode = searchMap.getString("mode");
    	...
    	try {
    		...
    		for (int i = 0; i < evalMembEmpns.length; i++) {
            	...
            	if("01".equals(gubun)){
  	            	...
  	            	returnMap = updateData("prs.mngCon.planConApprove.planConApproveData", searchMap);
  	            }else if("02".equals(gubun)){
  	            	searchMap.put("planStatusId","04");
  	            	searchMap.put("finalApprove","Y");
  	            	returnMap = updateData("prs.mngCon.planConApprove.updateData", searchMap);//계약서상태 변경
  	            }
  	        }
     ...
     * @throws 
     */
    public SearchMap listReturnDB(SearchMap searchMap) {
    	HashMap returnMap    = new HashMap();    
    	...
    	try {
    		...
    		String[] approveUserIds = searchMap.getString("approveUserIds").split("\\|");
    		String userId = searchMap.getString("userId");
    		String gubun = searchMap.getString("gubun");
    		...
    		for (int i = 0; i < evalMembEmpns.length; i++) {
  	            	...
  	            	returnMap = updateData("prs.mngCon.planConApprove.updateData", searchMap);
  	            	returnMap = insertData("prs.mngCon.planConApprove.insertHistoryData", searchMap);// 성과계획서 이력등록
  	    			returnMap = insertData("prs.mngCon.planConApprove.insertTargetHistoryData", searchMap);// 목표관리 이력등록
  	        }
    ...
    /**
     * 직원개인평가 부서장/주관부서확인 엑셀다운로드
     * @param      
     * @return String  
     * @throws 
     */  
    public SearchMap evalMngListExcel(SearchMap searchMap) {
        String excelFileName = "직원개인평가 확인";
        String excelTitle = "직원개인평가 확인 리스트";
        ...
        searchMap.put("excelDataList", (ArrayList)getList("prs.mngCon.planConApprove.getEvalList", searchMap));
