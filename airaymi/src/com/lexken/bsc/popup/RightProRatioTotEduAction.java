...
public class RightProRatioTotEduAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap rightProRatioTotEduList(SearchMap searchMap) {
    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.rightProRatioTotEdu.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.rightProRatioTotEdu.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.rightProRatioTotEdu.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap rightProRatioTotEduList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.rightProRatioTotEdu.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.rightProRatioTotEdu.getList", searchMap));
