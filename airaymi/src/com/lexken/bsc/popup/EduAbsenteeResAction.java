...
public class EduAbsenteeResAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap eduAbsenteeResList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.eduAbsenteeRes.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.eduAbsenteeRes.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.eduAbsenteeRes.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap eduAbsenteeResList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.eduAbsenteeRes.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "교육불참자해소노력";
    	String excelTitle = "교육불참자해소노력";
    	...
    	excelInfoList.add(new ExcelVO("교육시작일", 	"EDU_ST_DATE", 		"center"));
    	excelInfoList.add(new ExcelVO("교육종료일", 	"EDU_END_DATE", 	"center"));
    	excelInfoList.add(new ExcelVO("교육계획인원", 	"EDU_PLAN_PESN", 	"center"));
    	excelInfoList.add(new ExcelVO("교육대상인원", 	"EDU_TARG_PESN", 	"center"));
    	excelInfoList.add(new ExcelVO("교육신청인원", 	"EDU_RCPT_PESN", 	"center"));
    	excelInfoList.add(new ExcelVO("불참자", 		"EDU_REMN_PESN", 	"center"));
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.eduAbsenteeRes.getList", searchMap));
