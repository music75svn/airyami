...
public class SystemItemAction extends CommonService {
     ...
     * @throws 
     */
    public SearchMap systemItemList(SearchMap searchMap) {
     ...
     * @throws 
     */
    public SearchMap systemItemList_xml(SearchMap searchMap) {
        
        searchMap.addList("list", getList("bsc.system.systemItem.getList", searchMap));
