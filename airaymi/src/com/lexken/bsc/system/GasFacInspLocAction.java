...
public class GasFacInspLocAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap gasFacInspLocList(SearchMap searchMap) {

    	searchMap.addList("deptList", getList("bsc.system.gasFacInspLoc.getDeptList", searchMap));
     ...
     * @throws
     */
    public SearchMap gasFacInspLocList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.system.gasFacInspLoc.getList", searchMap));
