...
public class ActualStatusAction extends CommonService {
    ...
    public SearchMap actualStatusInsertList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.tam.actualStatus.getInsertList", searchMap));
    ...
    public SearchMap actualStatusCheckList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.tam.actualStatus.getCheckList", searchMap));
    ...
    public SearchMap actualStatusApproveList_xml(SearchMap searchMap) {
    	...
    	searchMap.addList("list", getList("bsc.tam.actualStatus.getApproveList", searchMap));
    ...
    public SearchMap actualInsertStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.tam.actualStatus.getInsertList", searchMap));
    ...
    public SearchMap actualCheckStatusListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelSearchInfoList", excelSearchInfoList);
    	searchMap.put("excelInfoList", excelInfoList);
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.tam.actualStatus.getApproveList", searchMap));
    ...
    public SearchMap actualStatusModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("bsc.tam.actualStatus.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("bsc.tam.actualStatus.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("bsc.tam.actualStatus.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    /*
	    try {
	        String[] actualStatusIds = searchMap.getString("actualStatusIds").split("\\|", 0);
	        
	        setStartTransaction();
	        
	        for (int i = 0; i < actualStatusIds.length; i++) {
	            searchMap.put("actualStatusId", actualStatusIds[i]);
	            returnMap = updateData("bsc.tam.actualStatus.deleteData", searchMap);
	        }
