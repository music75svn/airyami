...
public class StudentPerPersonAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap studentPerPersonList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.studentPerPerson.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.popup.studentPerPerson.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.studentPerPerson.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap studentPerPersonList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.studentPerPerson.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "1인당교육생수";
    	String excelTitle = "1인당교육생수";
    	...
    	excelInfoList.add(new ExcelVO("이름", 	"NM", 				"center"));
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.studentPerPerson.getList", searchMap));
