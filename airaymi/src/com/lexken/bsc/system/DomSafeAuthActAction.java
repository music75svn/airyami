...
public class DomSafeAuthActAction extends CommonService {
    ...
    public SearchMap domSafeAuthActList(SearchMap searchMap) {
    	...
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.system.domSafeAuthAct.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.system.domSafeAuthAct.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.system.domSafeAuthAct.getItem", searchMap));
    ...
    public SearchMap domSafeAuthActList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.system.domSafeAuthAct.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.system.domSafeAuthAct.getList", searchMap));
