...
private static final long serialVersionUID = 1L;
    ...
    public SearchMap targetInputTermList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.tam.targetInputTerm.getList", searchMap));
    ...
    public SearchMap targetInputTermModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("bsc.tam.targetInputTerm.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	         ...
	         * 해당 년도 등록여부 확인
	         **********************************/
	        int cnt = getInt("bsc.tam.targetInputTerm.getCount", searchMap);
	        ...
	        if(0 < cnt) {
	        	...
	        	returnMap = insertData("bsc.tam.targetInputTerm.insertData", searchMap);
	        }  
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("bsc.tam.targetInputTerm.updateData", searchMap);
	    ...
	    try {
	        ...
	        if(null != years && 0 < years.length) {
	        	 for (int i = 0; i < years.length; i++) {
		            ...
		            returnMap = updateData("bsc.tam.targetInputTerm.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap targetInputTermListExcel(SearchMap searchMap) {
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.tam.targetInputTerm.getList", searchMap));
