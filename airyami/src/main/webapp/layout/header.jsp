...
function fn_callBackHMenu(sid, result, data){
	...
	if(sid == "headMenuList"){
		var innerhtml = "<h2><img src=\"/dWise/images/admin/hTitle_admin.gif\" alt=\"관리자 모드\"></h2><ul>";
...
<div id="header">
	<div id="logo">
		<h1><a href="#"><img src="/dWise/images/admin/logo.gif" alt="기업가정신 종합정보망"></a></h1>
		<span id="userLogo"></span>
	</div>
	<div id="top_link"></div>
	<div id="gnb">
	<!-- 
		<h2><img src="/dWise/images/admin/hTitle_admin.gif" alt="관리자 모드"></h2>
		<ul>
