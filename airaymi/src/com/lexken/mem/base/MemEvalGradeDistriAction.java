...
public class MemEvalGradeDistriAction extends CommonService {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriList(SearchMap searchMap) {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriList_xml(SearchMap searchMap) {
        
        searchMap.addList("list", getList("mem.base.memEvalGradeDistri.getList", searchMap));
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriModify(SearchMap searchMap) {
    	String stMode = searchMap.getString("mode");
        
    	searchMap.addList("evalMethodDetail", getDetail("mem.base.memEvalGrade.getDetail", searchMap));
    	
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("mem.base.memEvalGradeDistri.getDetail", searchMap));
    	}
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriTabMngList(SearchMap searchMap) {
    	...
    	searchMap.addList("itemList", getList("mem.base.memEvalGradeDistri.getList", searchMap));
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriTabMngList_xml(SearchMap searchMap) {
    	
    	
    	/**********************************
         * 등급배분표 등급 가져오기
         **********************************/
    	ArrayList itemList = (ArrayList)getList("mem.base.memEvalGradeDistri.getList", searchMap);
        ...
        searchMap.addList("list", getList("mem.base.memEvalGradeDistri.evalGradeDistriTabMngList", searchMap));
     ...
     * @throws 
     */
    public SearchMap memEvalGradeDistriProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("mem.base.memEvalGradeDistri.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("mem.base.memEvalGradeDistri.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
			...
			searchMap.put("gradeItemId", gradeItemIds[i]);
		            returnMap = updateData("mem.base.memEvalGradeDistri.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap evalGradeDistriListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("mem.base.memEvalGradeDistri.getList", searchMap));
    ...
    public SearchMap evalGradeDistriTabMngListExcel(SearchMap searchMap) {
    	...
    	ArrayList iqueryItemList = (ArrayList)getList("mem.base.memEvalGradeDistri.getList", searchMap);
    	String[] itemArray = new String[0]; 
    	...
    	searchMap.put("excelSearchInfoList", excelSearchInfoList);
    	searchMap.put("excelInfoList", excelInfoList);
    	searchMap.put("excelDataList", (ArrayList)getList("mem.base.memEvalGradeDistri.evalGradeDistriTabMngList", searchMap));
        	...
        	if(null != excelDataList && 0 < excelDataList.size()) {
                ...
                for(int i=0; i< strCode.length ; i++) {
                	...
                	if( 0 == i ){ // 평가년도  설정  부분
                         ...
                         * 기존 등록된 실적 삭제
                         **********************************/
                        returnMap = insertData("mem.base.memEvalGradeDistri.deleteTabMngData", searchMap);
	                	...
	                	for(int j = 0 ; j < colCnt ; j++ ){
		                	if(!"".equals(StaticUtil.nullToBlank(strCode[i])) && !"".equals(StaticUtil.nullToBlank(strValue[i][j]))) {
			                	...
			                	returnMap = insertData("mem.base.memEvalGradeDistri.insertTabMngData", searchMap);
			                	inputValCnt++;
		                	}
	                	}
                	}
