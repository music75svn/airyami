...
public class CandidateEdcAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap candidateEdcList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
        	
			searchMap.put("findDeptId", getStr("bsc.popup.candidateEdc.getScDeptMapping", searchMap));
		}

        searchMap.addList("deptInfo", getList("bsc.popup.candidateEdc.getDeptInfo", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.candidateEdc.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap candidateEdcList_xml(SearchMap searchMap) {

    	String itemCd = searchMap.getString("findItemCd");

    		searchMap.addList("list", getList("bsc.popup.candidateEdc.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "양성교육 3년 평균수입+(3년 평균수입*10%) 실적";
    	String excelTitle = "양성교육 3년 평균수입+(3년 평균수입*10%) 실적";
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.candidateEdc.getList", searchMap));
    	return searchMap;
    }
