...
@Controller
public class PartnerPOController {
    ...
    /**
     * P/O Header 목록조회 페이지 이동 
     */
    @RequestMapping(value="/partner/poHList.do")
     ...
     * P/O Header 목록조회 
     */
    @RequestMapping(value="/partner/selectPOHList.do")
