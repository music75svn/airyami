...
function viewDirContextMenu(dirname,e) {	
	if(!e) e = event;
	var menu_array = new Array(
		"<span style='color:red'><img src='"+base_dir+"/images/delete.png' width='16' height='16' align='absmiddle'></span>|deleteDir('"+dirname+"')|이폴더삭제하기"
	);
	viewContextMenu(menu_array,e);
}
...
function viewFileContextMenu(dirname,filename,width,height,thumb_url,file_url,event) {
	var menu_array = new Array(
		"<span style='color:red'><img src='"+base_dir+"/images/image_property.png' width='16' height='16' align='absmiddle'></span>|viewImagePropery('"+dirname+"','"+filename+"','"+width+"','"+height+"','"+thumb_url+"','"+file_url+"',event)|이미지 상세정보",
		"<span style='color:red'><img src='"+base_dir+"/images/delete.png' width='16' height='16' align='absmiddle'></span>|deleteOneFile('"+dirname+"','"+filename+"')|이파일 삭제하기"
	);
...
function insertImageOpenerProperty() {
	...
	var d = new Date();
	if(link == '') {
		html	= "<img src='"+src+"' width='"+width+"' height='"+height+"' align='"+align+"' alt='"+alt+"' title='"+alt+"'>";
	} else {
		html	= "<a href='"+link+"' target='"+target+"' title='"+alt+"'><img src='"+src+"' width='"+width+"' height='"+height+"' align='"+align+"'></a>";
	}
	if (isIE()) {
		opener.document.getElementById('spaceditor_id_iframe').contentWindow.focus();
		var obj = opener.document.frames["spaceditor_id_iframe"].document.selection.createRange();
