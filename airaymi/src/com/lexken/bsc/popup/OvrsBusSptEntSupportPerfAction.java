...
public class OvrsBusSptEntSupportPerfAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap ovrsBusSptEntSupportPerfList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.ovrsBusSptEntSupportPerf.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.ovrsBusSptEntSupportPerf.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.ovrsBusSptEntSupportPerf.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap ovrsBusSptEntSupportPerfList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.ovrsBusSptEntSupportPerf.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	excelInfoList.add(new ExcelVO("가중치합", 	"INSP_QTY_RST", 		"center"));
    	...
    	*/
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.ovrsBusSptEntSupportPerf.getList", searchMap));
