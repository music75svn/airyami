...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		formatCol = function (pos, rowInd, tv, rawObject, rowId, rdata){
			...
			if(ral) { result += "text-align:"+ral+";vertical-align:middle;"; }
			...
			result += (clas !== undefined ? (" class=\""+clas+"\"") :"") + ((cm.title && tv) ? (" title=\""+$.trim($.jgrid.stripHtml(tv).replace(/\n/g, ' '))+"\"") :"");//줄바꿈 스페이스로 변환(2012.10.27 하윤식)
