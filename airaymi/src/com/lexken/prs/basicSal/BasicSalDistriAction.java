...
public class BasicSalDistriAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap basicSalDistriList(SearchMap searchMap) {
    	...
    	searchMap.addList("gradeList",  getList("prs.basicSal.basicSalDistri.getGradeList", searchMap));
     ...
     * @throws
     */
    public SearchMap basicSalDistriList_xml(SearchMap searchMap) {

    	/**********************************
         * 등급배분표 등급 가져오기
         **********************************/
    	ArrayList itemList = (ArrayList)getList("prs.basicSal.basicSalDistri.getGradeList", searchMap);
        ...
        searchMap.addList("list", getList("prs.basicSal.basicSalDistri.basicSalDistriTabList", searchMap));
     ...
     * @throws
     */
    public SearchMap basicSalDistriListExcel(SearchMap searchMap) {
    	...
    	ArrayList gradeList = (ArrayList)getList("prs.basicSal.basicSalDistri.getGradeList", searchMap);
    	...
    	ArrayList iqueryGradeList = (ArrayList)getList("prs.basicSal.basicSalDistri.getGradeList", searchMap);
    	...
    	searchMap.put("excelDataList", getList("prs.basicSal.basicSalDistri.basicSalDistriTabList", searchMap));
    ...
    public SearchMap excelUploadProcess(SearchMap searchMap) {
        ...
        searchMap = basicSalDistriTabUpExcel(searchMap);
     ...
     * @throws
     */
    public SearchMap basicSalDistriTabUpExcel(SearchMap searchMap) {
        ...
        try {
        	...
        	if(null != excelDataList && 0 < excelDataList.size()) {
                 ...
                 * 기존 등록된 실적 삭제
                 **********************************/
                returnMap = deleteData("prs.basicSal.basicSalDistri.deleteTabData", searchMap, true);
                	...
                	if( 0 == i ){ // 평가년도  설정  부분
	                	...
	                	for(int j = 0 ; j < colCnt ; j++ ){
		                	if(!"".equals(StaticUtil.nullToBlank(strCode[i])) && !"".equals(StaticUtil.nullToBlank(strValue[i][j]))) {
			                	...
			                	returnMap = insertData("prs.basicSal.basicSalDistri.insertTabData", searchMap);
			                	inputValCnt++;
		                	}
	                	}
                	}
