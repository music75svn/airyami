...
public class CommEduIncAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap commEduIncList(SearchMap searchMap) {
    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.commEduInc.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("getDeptList", getList("bsc.popup.commEduInc.getDeptList", searchMap));
    	
    	searchMap.addList("itemInfo", getList("bsc.popup.commEduInc.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap commEduIncList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.commEduInc.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "위탁교육수입(백만원)";
    	String excelTitle = "위탁교육수입(백만원)";
    	...
    	excelInfoList.add(new ExcelVO("교육구분", "ROLE_TC_NM", "left"));
    	...
    	excelInfoList.add(new ExcelVO("금액(백만원)", "REQ_AMT", "left"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.commEduInc.getList", searchMap));
