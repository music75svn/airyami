...
public class DeptCsfAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap deptCsfList(SearchMap searchMap) {
     ...
     * @throws
     */
    public SearchMap deptCsfList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.base.deptCsf.getList", searchMap));
     ...
     * @throws
     */
    public SearchMap deptCsfModify(SearchMap searchMap) {
    	String stMode = searchMap.getString("mode");

    	searchMap.addList("treeList", getList("bsc.module.commModule.getScDeptList", searchMap));

    	searchMap.addList("csfList", getList("bsc.base.deptCsf.getCsfList", searchMap));
    	searchMap.addList("deptCsfList", getList("bsc.base.deptCsf.getDeptCsfList", searchMap));

//    	searchMap.addList("detail", getDetail("bsc.base.deptCsf.getDetail", searchMap));
     ...
     * @throws
     */
    public SearchMap deptCsfProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	String csfId = searchMap.getString("csfIds");
        	String [] csfs = searchMap.getString("csfIds").split("\\|", 0);



        	if (csfId != null) {
	        	for (int i = 0; i < csfs.length; i++) {
	        		searchMap.put("csfId", csfs[i]);
	        		deleteData("bsc.base.deptCsf.deleteScDeptCsf", searchMap, true);
	        	}
        	}

        	String deptCsfsId = searchMap.getString("deptCsfsIds");
        	String [] deptCsfs = searchMap.getString("deptCsfsIds").split("\\|", 0);

        	if (deptCsfsId != null && !"".equals(deptCsfsId)) {
	        	for (int i = 0; i < deptCsfs.length; i++) {
	        		searchMap.put("csfId", deptCsfs[i]);
	        		returnMap = insertData("bsc.base.deptCsf.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("bsc.base.deptCsf.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
        ...
        HashMap returnMap = new HashMap();
	    try {
	        String[] csfIds = searchMap.getString("delCsfIds").split("\\|", 0);

	        setStartTransaction();

	        for (int i = 0; i < csfIds.length; i++) {
	            searchMap.put("csfId", csfIds[i]);
	            returnMap = deleteData("bsc.base.deptCsf.deleteData", searchMap);
	        }
    ...
    public SearchMap batchDB(SearchMap searchMap) {
        ...
        try {
        	...
        	for (int i = 0; i < csfIds.length; i++) {
	            ...
	            returnMap = updateData("bsc.base.deptCsf.updateBatchData", searchMap);
        	}
     ...
     * @throws
     */
    public SearchMap deptCsfExcel(SearchMap searchMap) {
    	String excelFileName = "CSF";
    	String excelTitle = "CSF 리스트";
    	...
    	excelInfoList.add(new ExcelVO("CSF코드", "CSF_ID", "center", "CNT"));
    	excelInfoList.add(new ExcelVO("CSF명", "CSF_NM", "left", "CNT", 8000));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.base.deptCsf.getExcelList", searchMap));
