...
public class RightProRatioTotRscAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap rightProRatioTotRscList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.rightProRatioTotRsc.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.rightProRatioTotRsc.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.rightProRatioTotRsc.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap rightProRatioTotRscList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.rightProRatioTotRsc.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "계약업무적기처리율(총계약건수)";
    	String excelTitle = "계약업무적기처리율(총계약건수)";
    	...
    	excelInfoList.add(new ExcelVO("구매유형", "BUY_KIND_TC_N_NM", "left"));
    	excelInfoList.add(new ExcelVO("사업장명", "BULC_CD_N", "left"));
    	excelInfoList.add(new ExcelVO("구매부서명", "BUY_DEPT_CD_N", "left"));
    	excelInfoList.add(new ExcelVO("의뢰부서명", "BUY_RQST_DEPT_CD_NM", "left"));
    	excelInfoList.add(new ExcelVO("계약종류", "AGRE_KIND_TC_NM", "left"));
    	excelInfoList.add(new ExcelVO("계약구분", "BUY_METH_TC_NM", "left"));
    	excelInfoList.add(new ExcelVO("구매의뢰일자", "BUY_RQST_DATE", "left"));
    	excelInfoList.add(new ExcelVO("계약일자", "AGRE_DATE", "left"));
    	excelInfoList.add(new ExcelVO("계약시작일자", "AGRE_ST_DATE", "left"));
    	excelInfoList.add(new ExcelVO("계약제목", "AGRE_TITL", "left"));
    	excelInfoList.add(new ExcelVO("총계약금액", "TOT_AMT", "left"));
    	excelInfoList.add(new ExcelVO("거래처", "CUST_CD_NM", "left"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.rightProRatioTotRsc.getList", searchMap));
