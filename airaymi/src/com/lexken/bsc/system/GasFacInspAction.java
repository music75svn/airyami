...
public class GasFacInspAction extends CommonService {
	 ...
	 private static final long serialVersionUID = 1L;
	     ...
	     * @throws
	     */
	    public SearchMap gasFacInspList(SearchMap searchMap) {

	    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
	    		searchMap.put("findDeptId", getStr("bsc.system.gasFacInsp.getScDeptMapping", searchMap));
	    	}
	    	
	    	searchMap.addList("deptList", getList("bsc.system.gasFacInsp.getDeptList", searchMap));

	    	searchMap.addList("itemInfo", getList("bsc.system.gasFacInsp.getItem", searchMap));
	     ...
	     * @throws
	     */
	    public SearchMap gasFacInspList_xml(SearchMap searchMap) {

	        searchMap.addList("list", getList("bsc.system.gasFacInsp.getList", searchMap));
	    ...
	    public SearchMap excel(SearchMap searchMap) {
	    	...
	    	excelInfoList.add(new ExcelVO("처리건수", "INSP_QTY", "left"));
	    	...
	    	searchMap.put("excelDataList", (ArrayList)getList("bsc.system.gasFacInsp.getList", searchMap));
