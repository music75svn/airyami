...
public class OuterEduAttendAction extends CommonService {
    ...
    public SearchMap outerEduAttendList(SearchMap searchMap) {
    	...
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.system.outerEduAttend.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.system.outerEduAttend.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.system.outerEduAttend.getItem", searchMap));
    ...
    public SearchMap outerEduAttendList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.system.outerEduAttend.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.system.outerEduAttend.getList", searchMap));
