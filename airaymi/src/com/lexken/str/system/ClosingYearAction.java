...
public class ClosingYearAction extends CommonService {
    ...
    public SearchMap closingYearList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("str.system.closingYear.getList", searchMap));
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = insertData("str.system.closingYear.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        int existCnt = getInt("str.system.closingYear.getListCnt", searchMap);
	        
	        if(existCnt > 0){
	        	returnMap = updateData("str.system.closingYear.updateData", searchMap);
	        } else {
	        	returnMap = insertData("str.system.closingYear.insertData", searchMap);
	        }
