...
public class ExcepActionAction extends CommonService {
     ...
     * @throws 
     */
    public SearchMap excepActionList(SearchMap searchMap) {
         ...
         * 평가자 조회
         **********************************/
    	searchMap.addList("evalUserList", getList("cbe.excep.excepAction.getUserList", searchMap));
    	...
    	searchMap.addList("getEvalPeriodYn", getStr("cbe.excep.excepAction.getEvalPeriodYn", searchMap));
     ...
     * @throws 
     */
    public SearchMap excepActionList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("cbe.excep.excepAction.getList", searchMap));
     ...
     * @throws 
     */
    public SearchMap excepActionModify(SearchMap searchMap) {
    	
    	String stMode = searchMap.getString("mode");
    	
    	searchMap.addList("detail", getDetail("cbe.excep.excepAction.getDetail", searchMap));
         ...
         * 첨부파일 조회
         **********************************/
    	searchMap.addList("fileList", getList("cbe.excep.excepAction.getFileList", searchMap));
         ...
         * 첨부등급 조회
         **********************************/
    	searchMap.addList("gradeList", getList("cbe.excep.excepAction.getGradeList", searchMap));
     ...
     * @throws 
     */
    public SearchMap excepActionProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("cbe.excep.excepAction.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("cbe.excep.excepAction.updateData", searchMap);
    ...
    public SearchMap updateSubmitDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("cbe.excep.excepAction.updateSubmitData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
			...
			searchMap.put("scDeptId", scDeptIds[i]);
		            returnMap = updateData("cbe.excep.excepAction.deleteData", searchMap);
		        }
		    }
     ...
     * @throws 
     */  
    public SearchMap excepActionListExcel(SearchMap searchMap) {
    	...
    	excelInfoList.add(new ExcelVO("EVAL_USER_NM", "EVAL_USER_NM", "left"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("cbe.excep.excepAction.getList", searchMap));
