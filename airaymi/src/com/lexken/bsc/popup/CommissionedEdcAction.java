/*************************************************************************
* CLASS 명      : commissionedEdc
* 작 업 자      : 안요한
* 작 업 일      : 2013년 08월 13일
* 기    능      : 위탁교육 수강인원 3개년 평균대비 110% 달성(2,109명)
* ---------------------------- 변 경 이 력 --------------------------------
...
public class CommissionedEdcAction extends CommonService {

    private static final long serialVersionUID = 1L;

    /**
     * 위탁교육 수강인원 3개년 평균대비 110% 달성(2,109명) 조회
     * @param
     * @return String
     * @throws
     */
    public SearchMap commissionedEdcList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
        	
			searchMap.put("findDeptId", getStr("bsc.popup.commissionedEdc.getScDeptMapping", searchMap));
		}

        searchMap.addList("deptInfo", getList("bsc.popup.commissionedEdc.getDeptInfo", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.commissionedEdc.getItem", searchMap));

        return searchMap;
    }

    /**
     * 위탁교육 수강인원 3개년 평균대비 110% 달성(2,109명) 데이터 조회(xml)
     * @param
     * @return String
     * @throws
     */
    public SearchMap commissionedEdcList_xml(SearchMap searchMap) {

    	String itemCd = searchMap.getString("findItemCd");

    		searchMap.addList("list", getList("bsc.popup.commissionedEdc.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "위탁교육 수강인원 3개년 평균대비 110% 달성(2,109명) 실적";
    	String excelTitle = "위탁교육 수강인원 3개년 평균대비 110% 달성(2,109명) 실적";
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.commissionedEdc.getList", searchMap));
    	return searchMap;
    }
