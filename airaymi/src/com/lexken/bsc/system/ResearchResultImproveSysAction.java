...
public class ResearchResultImproveSysAction extends CommonService {
    ...
    public SearchMap researchResultImproveSysList(SearchMap searchMap) {
    	...
    	if("".equals(StaticUtil.nullToBlank(deptId))) {
    		searchMap.addList("dept", getList("bsc.system.researchResultImproveSys.getDept", searchMap));
        ...
        if( "01".equals(searchMap.getString("findFlag")) ){
        	searchMap.addList("deptInfo", getList("bsc.system.researchResultImproveSys.getDeptInfo", searchMap));
        }else {
        	searchMap.addList("deptInfo", getList("bsc.system.researchResultImproveSys.getDeptTechInfo", searchMap));
        }
    	
    	searchMap.addList("itemInfo", getList("bsc.system.researchResultImproveSys.getItem", searchMap));
    ...
    public SearchMap researchResultImproveSysList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.system.researchResultImproveSys.getList", searchMap));
    ...
    public SearchMap researchResultTechSuptList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.system.researchResultImproveSys.getTechList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	if (searchMap.get("flag").equals("01")) {
    	...
    	if (searchMap.get("flag").equals("01")) {
    		searchMap.put("excelDataList", (ArrayList)getList("bsc.system.researchResultImproveSys.getList", searchMap));
    	} else {
    		searchMap.put("excelDataList", (ArrayList)getList("bsc.system.researchResultImproveSys.getTechList", searchMap));
    	}
