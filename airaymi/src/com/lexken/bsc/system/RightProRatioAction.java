...
public class RightProRatioAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap rightProRatioList(SearchMap searchMap) {

    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.system.rightProRatio.getScDeptMapping", searchMap));
    	}
    	
    	searchMap.addList("deptList", getList("bsc.system.rightProRatio.getDeptList", searchMap));
     ...
     * @throws
     */
    public SearchMap rightProRatioList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.system.rightProRatio.getList", searchMap));
