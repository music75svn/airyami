...
public class GreenGasVerifyAction extends CommonService {
    ...
    public SearchMap greenGasVerifyList(SearchMap searchMap) {
    	...
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
			searchMap.put("findDeptId", getStr("bsc.popup.greenGasVerify.getScDeptMapping", searchMap));
		}

        searchMap.addList("deptInfo", getList("bsc.popup.greenGasVerify.getDeptInfo", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.greenGasVerify.getItem", searchMap));
    ...
    public SearchMap greenGasVerifyList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.popup.greenGasVerify.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "온실가스검증용역수주";
    	String excelTitle = "온실가스검증용역수주";
    	...
    	excelInfoList.add(new ExcelVO("검사구분", "ROLE_TC_NM", "center"));
    	excelInfoList.add(new ExcelVO("가스법 구분", "LAW_TC_NM", "center"));
    	excelInfoList.add(new ExcelVO("분류명", "STIC_SML_TC_NM", "center"));
    	excelInfoList.add(new ExcelVO("실적건수", "REQ_QTY", "center"));
    	excelInfoList.add(new ExcelVO("실적금액", "REQ_AMT", "center"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.greenGasVerify.getList", searchMap));
