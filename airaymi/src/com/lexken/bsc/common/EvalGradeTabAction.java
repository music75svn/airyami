...
public class EvalGradeTabAction extends CommonService {
    ...
    public SearchMap evalGradeTabList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.common.evalGradeTab.getList", searchMap));
    ...
    public SearchMap evalGradeTabModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("bsc.common.evalGradeTab.getDetail", searchMap));
    	}
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("bsc.common.evalGradeTab.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("bsc.common.evalGradeTab.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
			...
			searchMap.put("gradeItemId", gradeItemIds[i]);
		            returnMap = updateData("bsc.common.evalGradeTab.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap evalGradeTabListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.common.evalGradeTab.getList", searchMap));
