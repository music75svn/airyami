...
public class GasFacInspAction extends CommonService {
    ...
    public SearchMap gasFacInspList(SearchMap searchMap) {
    	...
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.gasFacInsp.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.gasFacInsp.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.gasFacInsp.getItem", searchMap));
    ...
    public SearchMap gasFacInspList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.popup.gasFacInsp.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	...
    	excelInfoList.add(new ExcelVO("배관검사", "LENG", "center"));
    	...
    	ArrayList list = (ArrayList)getList("bsc.popup.gasFacInsp.getList", searchMap);
