...
public class MemEvalGradeScoreAction extends CommonService {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeScoreList(SearchMap searchMap) {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeScoreList_xml(SearchMap searchMap) {
     ...
     * @throws 
     */
    public SearchMap memEvalGradeScoreModify(SearchMap searchMap) {
    	String stMode = searchMap.getString("mode");
    	
    	searchMap.addList("evalMethodDetail", getDetail("mem.base.memEvalGrade.getDetail", searchMap));
        
    	if("MOD".equals(stMode)) {
    		searchMap.addList("detail", getDetail("mem.base.memEvalGradeScore.getDetail", searchMap));
    	}
     ...
     * @throws 
     */
    public SearchMap memEvalGradeScoreProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = insertData("mem.base.memEvalGradeScore.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("mem.base.memEvalGradeScore.updateData", searchMap);
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
			...
			searchMap.put("gradeItemId", gradeItemIds[i]);
		            returnMap = updateData("mem.base.memEvalGradeScore.deleteData", searchMap);
		        }
		    }
    ...
    public SearchMap evalGradeScoreListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("mem.base.memEvalGradeScore.getList", searchMap));
