...
public class BosActionPlanAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap bosActionPlanList(SearchMap searchMap) {
     ...
     * @throws
     */
    public SearchMap bosActionPlanList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("gov.bos.bosActionPlan.getList", searchMap));
     ...
     * @throws
     */
    public SearchMap bosActionPlanModify(SearchMap searchMap) {
    	...
    	if("MOD".equals(stMode)) {
	         ...
	         * 지표그룹 상세조회
	         **********************************/
	    	detail = getDetail("gov.bos.bosActionPlan.getDetail", searchMap);
     ...
     * @throws
     */
    public SearchMap bosActionPlanProcess(SearchMap searchMap) {
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
	         ...
	         * 지표 코드 채번
	         **********************************/
	        String planId = getStr("gov.bos.bosActionPlan.getPlanId", searchMap);
	        searchMap.put("planId", planId);

        	returnMap = insertData("gov.bos.bosActionPlan.insertData", searchMap);
    ...
    public SearchMap updateDB(SearchMap searchMap) {
        ...
        try {
	        ...
	        returnMap = updateData("gov.bos.bosActionPlan.updateData", searchMap);
	    ...
	    try {
	        ...
	        if(null != planIds && 0 < planIds.length) {
		        for (int i = 0; i < planIds.length; i++) {
		            ...
		            returnMap = deleteData("gov.bos.bosActionPlan.deleteData", searchMap);
		        }
		    }
     ...
     * @throws
     */
    public SearchMap bosActionPlanListExcel(SearchMap searchMap) {
    	...
    	searchMap.put("excelDataList", getList("gov.bos.bosActionPlan.getList", searchMap));
