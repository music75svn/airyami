...
public class DomSafeAuthActAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap domSafeAuthActList(SearchMap searchMap) {

    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
    		searchMap.put("findDeptId", getStr("bsc.popup.domSafeAuthAct.getScDeptMapping", searchMap));
    	}

    	searchMap.addList("deptList", getList("bsc.popup.domSafeAuthAct.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.domSafeAuthAct.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap domSafeAuthActList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.domSafeAuthAct.getList", searchMap));
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "국내인증수입실적";
    	String excelTitle = "국내인증수입실적";
    	...
    	excelInfoList.add(new ExcelVO("수입(억원)", "REQ_AMT", "left"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.domSafeAuthAct.getList", searchMap));
