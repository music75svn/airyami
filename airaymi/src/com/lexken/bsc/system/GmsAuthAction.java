...
public class GmsAuthAction extends CommonService {
    ...
    public SearchMap gmsAuthList(SearchMap searchMap) {
    	...
    	if("".equals(StaticUtil.nullToBlank(deptId))) {
    		searchMap.addList("dept", getList("bsc.system.gmsAuth.getDept", searchMap));
    		searchMap.put("findDeptId", searchMap.getDefaultValue("dept", "DEPT_ID", 0));
    	}

    	searchMap.addList("deptList", getList("bsc.system.gmsAuth.getDeptList", searchMap));
    	
    	searchMap.addList("itemInfo", getList("bsc.system.gmsAuth.getItem", searchMap));
    ...
    public SearchMap gmsAuthList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.system.gmsAuth.getList", searchMap));
