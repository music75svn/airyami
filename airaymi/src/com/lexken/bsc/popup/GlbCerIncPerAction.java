...
public class GlbCerIncPerAction extends CommonService {
     ...
     * @throws
     */
    public SearchMap glbCerIncPerList(SearchMap searchMap) {
    	
    	if ("".equals(StaticUtil.nullToBlank((String)searchMap.get("findDeptId")))) {
			searchMap.put("findDeptId", getStr("bsc.popup.glbCerIncPer.getScDeptMapping", searchMap));
		}
    	
    	searchMap.addList("deptList", getList("bsc.popup.glbCerIncPer.getDeptList", searchMap));

    	searchMap.addList("itemInfo", getList("bsc.popup.glbCerIncPer.getItem", searchMap));
     ...
     * @throws
     */
    public SearchMap glbCerIncPerList_xml(SearchMap searchMap) {

        searchMap.addList("list", getList("bsc.popup.glbCerIncPer.getList", searchMap));
     ...
     * @throws
     */
    public SearchMap glbCerIncPerProcess(SearchMap searchMap) {
    ...
    public SearchMap excel(SearchMap searchMap) {
    	String excelFileName = "해외인증수입실적";
    	String excelTitle = "해외인증수입실적";
    	...
    	excelInfoList.add(new ExcelVO("금액", "REQ_AMT", "left"));
    	...
    	searchMap.put("excelDataList", (ArrayList)getList("bsc.popup.glbCerIncPer.getList", searchMap));
