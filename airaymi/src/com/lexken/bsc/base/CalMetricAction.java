...
public class CalMetricAction extends CommonService {
    ...
    public SearchMap calMetricList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.base.calMetric.getList", searchMap));
    ...
    public SearchMap calMetricScoreList_xml(SearchMap searchMap) {
        ...
        searchMap.addList("list", getList("bsc.base.calMetric.getDetail", searchMap));
     ...
     * @throws 
     */
    public SearchMap metricInfo_ajaxMain(SearchMap searchMap) {
        
    	searchMap.addList("metricList", getList("bsc.base.calMetric.getMetricDetailMain", searchMap));
    ...
    public SearchMap insertDB(SearchMap searchMap) {
        ...
        try {
        	...
        	returnMap = updateData("bsc.base.calMetric.updateData", searchMap);
        	
        	returnMap = updateData("bsc.base.calMetric.deleteAllData", searchMap, true);
        	...
        	if(subMetricIds != null) {
	        	for (int i = 0; i < subMetricIds.length; i++) {
		            ...
		            returnMap = insertData("bsc.base.calMetric.insertData", searchMap);
		        }
        	}
    ...
    public SearchMap deleteDB(SearchMap searchMap) {
	    ...
	    try {
	        ...
	        for (int i = 0; i < delSubMetricIds.length; i++) {
	            ...
	            returnMap = updateData("bsc.base.calMetric.deleteData", searchMap, true);
	        }
